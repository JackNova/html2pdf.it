...
var ALLOWED_DOMAINS = ['www.mastergol.it'];
...
module.exports = function (app) {
	app.get("/", function (req, res, next) {
		...
		//serve only allowed domains
		if (ALLOWED_DOMAINS.indexOf(url.split('/')[2]) < 0) {
			return res.send(400, format('Specified domain is not allowed'));
		};
